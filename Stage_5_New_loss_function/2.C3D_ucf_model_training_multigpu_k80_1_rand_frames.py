...
iterations= 30 # (int(total_train_videos/memory_batch_size_train)) #10001
custom_global_step=0
LOG_DIR='/nobackup/leopauly/logdirk80_1_rand_frames'
...
train_images, train_labels_cls, next_batch_start, _ = ucf. read_vid_and_label_rand_frames('./UCF101_data_preparation/train.list',memory_batch_size_train,-1,cluster_length,112,normalisation=False)
end_time = time.time()
