...
batch_size=16
batch_size_test=16
total_train_videos=7433
memory_batch_size_train=7433
memory_batch_size_test=825
iterations= 30 
custom_global_step=0
LOG_DIR='/nobackup/leopauly/S2l/MIME'
...
train_images, train_labels_cls, next_batch_start, _ = mime. read_vid_and_label('./train.list',memory_batch_size_train,-1,cluster_length,112,normalisation=False)
end_time = time.time()
...
test_images, test_labels_cls, next_batch_start, _ = mime.read_vid_and_label('./test.list',memory_batch_size_test,-1,16,112,normalisation=False)
