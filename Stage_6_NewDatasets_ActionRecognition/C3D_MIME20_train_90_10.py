...
batch_size=16
batch_size_test=16
total_train_videos=30375
memory_batch_size_train=30375
memory_batch_size_test=3375
iterations= 30 
custom_global_step=0
LOG_DIR='/nobackup/leopauly/S2l/MIME/90_10'
#saved_path='/nobackup/'
...
train_images, train_labels_cls, next_batch_start, _ = mime. read_vid_and_label('./train_90_10.list',memory_batch_size_train,-1,cluster_length,112,normalisation=False)
end_time = time.time()
...
test_images, test_labels_cls, next_batch_start, _ = mime.read_vid_and_label('./test_90_10.list',memory_batch_size_test,-1,16,112,normalisation=False)
